...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 0bcf4f6d-f56b-4839-9194-388bc3bb8de1
```

> `0bcf4f6d-f56b-4839-9194-388bc3bb8de1` is the password of the certificate, you can change it to any password you want.
